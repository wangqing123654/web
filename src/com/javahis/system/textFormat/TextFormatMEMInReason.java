 ...
 * @version 1.0
 */
public class TextFormatMEMInReason extends TTextFormat {
    ...
    public String getPopupMenuSQL() {
        String sql =
            ...
            " FROM SYS_DICTIONARY WHERE GROUP_ID = 'MEM_IN_REASON' ORDER BY SEQ, ID";
    return sql;
    }
