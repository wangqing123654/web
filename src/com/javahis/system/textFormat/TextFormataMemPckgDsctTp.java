 ...
 * @version 1.0
 */
public class TextFormataMemPckgDsctTp extends TTextFormat {
	public String getPopupMenuSQL() {

		String sql = " SELECT ID,CHN_DESC AS NAME,ENG_DESC AS ENNAME,PY1  FROM SYS_DICTIONARY WHERE GROUP_ID = 'MEM_PCKG_DSCT_TP' ORDER BY SEQ ";
		return sql;
	}
