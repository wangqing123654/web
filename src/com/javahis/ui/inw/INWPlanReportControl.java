 ...
 * <p>Title: 报告进度查询</p>
 *
 * <p>Description: 住院：报告进度查询</p>
 *
 * <p>Copyright: Copyright (c) 2008</p>
 *
 * <p>Company: Javahis</p>
 *
 * @author pangben 2017-11-23
 * @version 1.0
 */
public class INWPlanReportControl extends TControl {
     ...
     * @return
     */
    private boolean isExist(TParm parm,int i) {
    ...
    public TParm queryMedApply(String mrno){
    	...
    	if(!"".equals(this.getValueString("STATION_CODE"))){
    		sql.append(" AND STATION_CODE='"+this.getValue("STATION_CODE")+"'");
    	}
