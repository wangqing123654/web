...
/**
 * <p>Title: 门诊实收费用明细表[含电话地址]</p>
 *
 * <p>Description: 门诊实收费用明细表[含电话地址]</p>
 *
 ...
 * @version 1.0
 */
public class BILOpdPaidDetailPhoneControl extends TControl {
	private TTable table;
    public void onInit() {
        super.onInit(); 
        table=(TTable)this.getComponent("TABLE");
           
        String head="病案号,80;就诊号,90;姓名,60;性别,40;出生日期,80;就诊身份,140;客户来源,100,CUSTOMER_SOURCE;获知方式,80;联系人,80;手机号,100;现住址,110;详细地址,200;就诊时间,80;结算时间,140;" +
        ...
        String mapParm="MR_NO;CASE_NO;PAT_NAME;SEX_CODE;BIRTH_DATE;CTZ_DESC;CUSTOMER_SOURCE;CHN_DESC;CONTACTS_NAME;CONTACTS_TEL;POST_DESCRIPTION;CURRENT_ADDRESS;ADM_DATE;BILL_DATE;" +
		...
		"14,left;15,left;16,left;17,left;18,left;19,left;20,left;21,left;22,right;23,right;24,right;25,right;26,right;" +
		"27,right;28,right;29,right;30,right;31,right;32,right;33,right;34,right;35,right;36,right;37,right;38,right;" +
		"39,right;40,right;41,right;42,right;43,right;44,right;45,right;46,right;47,right;48,right;49,right;50,right;51,right;52,right;53,right;54,right;55,right;56,right;57,right;58,right";
...
//        this.callFunction("UI|TABLE|removeRowAll");
    ...
    public void onPrint(){
       ...
       //标题
         parm.setData("TITLE", "TEXT","门急诊实收入明细报表[含电话地址]");
    ...
    public void onExcel() {
        ...
        ExportExcelUtil.getInstance().exportExcel(table, "门急诊实收入明细报表[含电话地址]");
    }
