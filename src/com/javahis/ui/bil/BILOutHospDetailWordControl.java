...
//        //modify by lim 2012/05/04 end
    ...
    private TParm getPrintDate(String startTime, String endTime,
        ...
        String sql =
                ...
                " H.PAT_NAME,A.MR_NO,A.IPD_NO,G.CTZ_DESC,A.CASE_NO " +
...
//              " AND D.DS_DATE BETWEEN TO_DATE ('" + startTime +
                ...
                deptWhere +
                regionWhere +
                " GROUP BY A.MR_NO,A.IPD_NO,A.CASE_NO,H.PAT_NAME,B.DEPT_CODE,B.STATION_CODE,C.REXP_CODE, E.DEPT_ABS_DESC ,F.STATION_DESC,G.CTZ_DESC ORDER BY IPD_NO";
...
//
//        resultParm.addData("SYSTEM", "COLUMNS", "DIAG");
