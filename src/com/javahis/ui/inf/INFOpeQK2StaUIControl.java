 ...
 * @version 1.0
 */
public class INFOpeQK2StaUIControl  extends TControl{
   ...
   */
	...
	public void onQuery() {
		...
		TParm result=INFOpeQK2StaUITool.getInstance().getselectInum(parm);
		...
		for(int i=0;i<result.getCount();i++){
			...
			TParm resultAnt=INFOpeQK2StaUITool.getInstance().getselectAntnum(result.getValue("CASE_NO",i),parm);
    ...
    public void onExport() {
        ...
        ExportExcelUtil.getInstance().exportExcel(table, "医院手术切口感染监测记录(2)");
    }
