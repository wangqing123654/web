...
/**
 *
 * <p>Title: SYS Fee(active_flg 为 N) 下拉选择框</p>
 *
 * <p>Description: </p> 
 *
 ...
 * <p>Company: JavaHis</p>
 *
 * @author fux 2009.1.16
 * @version 1.0 
 */
public class SYSFeeNPopupControl
    extends TControl {
...
//            return;
    ...
    public boolean filter(TParm parm, int row) {
    	//System.out.println("=====order code ====="+parm.getValue("ORDER_CODE", row) + " " + parm.getValue("ACTIVE_FLG", row));  
        boolean result =
            ...
            //("Y".equals(parm.getValue("ACTIVE_FLG", row).toUpperCase()));
             ("N".equals(parm.getValue("ACTIVE_FLG", row).toUpperCase()));  
                ...
                case 6:
                    ...
                    result = result &&  
                        ("N".equalsIgnoreCase(setMain)           
                         ...
                         //泰心应该是    
                         //cat1Code.equalsIgnoreCase("EXM"));  
//                         && cat1Code.equalsIgnoreCase("OTH")||cat1Code.equalsIgnoreCase("LIS")
//                         ||cat1Code.equalsIgnoreCase("RIS")||cat1Code.equalsIgnoreCase("TRT") 
                         //); 
                    
            }
        }
        
        //组套(System.out.println("5555555555555555555555"))
