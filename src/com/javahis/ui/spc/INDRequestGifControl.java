...
//                         "合计(大写): " + StringUtil.getInstance().numberToWord(atm));
    ...
    public void popReturn(String tag, Object obj) {  
        ...
        // 库存单位
        //fux  modify 20150319  调拨单位默认为配药单位  DOSAGE_UNIT
...
//                                        2);
    ...
    public boolean onTableDChangeValue(Object obj) {
        ...
        if ("QTY".equals(columnName)) {
            ...
            this.setValue("SUM_RETAIL_PRICE", Math.round(getSumRetailPrice()));
            return false;
        }
        return true;
    }
    ...
    private boolean getOrgStockCheck() {
        /** 出库部门药品录入管控 */
    	//fux modify 20141119 APP_ORG_CODE->TO_ORG_CODE
