...
/**
*
* <p>Title: 礼品卡售价选择礼品卡种类</p>
*
* <p>Description: 礼品卡售价选择礼品卡种类</p>
...
* @version 1.0
*/
public class MEMCaseCardInfoControl extends TControl {
	
	public  MEMCaseCardInfoControl(){}
...
//        retail_price = parm.getValue("retail_price");
    ...
    public void filter() {
        TParm result = new TParm(TJDODBTool.getInstance().select(
            MEMSQL.getCaseCardInfo(getValueString("EDIT")
                               .toUpperCase())));
        table.setParmValue(result);
    }
    /**
