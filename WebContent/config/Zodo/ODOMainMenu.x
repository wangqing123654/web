<Type=TMenuBar>
UI.Item=File;Window
UI.button=save;|;tempsave;|;ekt;|;delete;|;clear;|;ClearMenu;|;caseHistory;|;showpat;|;crm;|;showPatDetail;|;toTemplate;|;AbnormalReg;CallNumber;|;mrshow;|;singledise;|;searchFee;|;close
