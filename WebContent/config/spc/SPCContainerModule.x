...
#  version 1.0
#
Module.item=queryInfo;insertInfo;queryMxInfo;queryMXByToxicId;updateOrderCode;deleteInfo;queryISMj;updateInfo


queryInfo.Type=TSQL
queryInfo.SQL= SELECT A.CONTAINER_ID,A.CONTAINER_DESC,A.ORDER_CODE,A.PY_CODE,A.DESCRIPTION,&
				B.ORDER_DESC,A.RFID_ID,A.TOXIC_QTY FROM IND_CONTAINERM A,&
			   SYS_FEE B WHERE A.ORDER_CODE=B.ORDER_CODE ORDER BY A.CONTAINER_ID
